...
sudo apt install libserialport0 patchelf python3-serial mint-meta-codecs snapd git build-essential gdb cmake android-sdk-platform-tools python3-pip bspwm htop minicom mat2 bleachbit dconf-editor workrave pdfarranger gnome-boxes tilp2 cura inkscape kiwix freecad arduino chromium telegram-desktop xournalpp musescore3 scribus mixxx zeal gnome-feeds audacity shotcut ffmpeg easytag -y
if $DATA_DRIVE
then
