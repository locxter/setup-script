...
gsettings set org.gnome.shell app-picker-layout "[{'ca.desrt.dconf-editor.desktop': <{'position': <0>}>, 'setup-mozc.desktop': <{'position': <1>}>, 'syncthing-start.desktop': <{'position': <2>}>, 'syncthing-ui.desktop': <{'position': <3>}>, 'org.gnome.Calculator.desktop': <{'position': <4>}>, 'org.gnome.gedit.desktop': <{'position': <5>}>, 'arduino.desktop': <{'position': <6>}>, 'audacity.desktop': <{'position': <7>}>, 'org.bleachbit.BleachBit.desktop': <{'position': <8>}>, 'org.gnome.Boxes.desktop': <{'position': <9>}>, 'bleachbit-root.desktop': <{'position': <10>}>, 'org.gnome.NetworkDisplays.desktop': <{'position': <11>}>, 'easytag.desktop': <{'position': <12>}>, 'org.gabmus.gfeeds.desktop': <{'position': <13>}>, 'htop.desktop': <{'position': <14>}>, 'display-im6.q16.desktop': <{'position': <15>}>, 'com.ultimaker.cura.desktop': <{'position': <16>}>, 'org.inkscape.Inkscape.desktop': <{'position': <17>}>, 'org.kicad.kicad.desktop': <{'position': <18>}>, 'org.kicad.gerbview.desktop': <{'position': <19>}>}, {'org.kicad.bitmap2component.desktop': <{'position': <0>}>, 'org.kicad.pcbcalculator.desktop': <{'position': <1>}>, 'org.kicad.pcbnew.desktop': <{'position': <2>}>, 'org.kicad.eeschema.desktop': <{'position': <3>}>, 'org.kiwix.desktop.desktop': <{'position': <4>}>, 'minicom.desktop': <{'position': <5>}>, 'org.mixxx.Mixxx.desktop': <{'position': <6>}>, 'mscore3.desktop': <{'position': <7>}>, 'com.github.jeromerobert.pdfarranger.desktop': <{'position': <8>}>, 'org.shotcut.Shotcut.desktop': <{'position': <9>}>, 'solaar.desktop': <{'position': <10>}>, 'webapp-Beatbump0264.desktop': <{'position': <11>}>, 'tilp.desktop': <{'position': <12>}>, 'vlc.desktop': <{'position': <13>}>, 'webapp-Discord6109.desktop': <{'position': <14>}>, 'com.github.xournalpp.xournalpp.desktop': <{'position': <15>}>, 'org.signal.Signal.desktop': <{'position': <16>}>, 'io.elementary.appcenter.desktop': <{'position': <17>}>, 'freecad.desktop': <{'position': <18>}>, 'gnome-control-center.desktop': <{'position': <19>}>, 'net.ankiweb.Anki.desktop': <{'position': <20>}>, 'org.telegram.desktop.desktop': <{'position': <21>}>, 'libreoffice-startcenter.desktop': <{'position': <22>}>, 'libreoffice-calc.desktop': <{'position': <23>}>}, {'webapp-manager.desktop': <{'position': <0>}>, 'libreoffice-draw.desktop': <{'position': <1>}>, 'libreoffice-impress.desktop': <{'position': <2>}>, 'libreoffice-math.desktop': <{'position': <3>}>, 'libreoffice-writer.desktop': <{'position': <4>}>, 'gnome-language-selector.desktop': <{'position': <5>}>, 'org.gnome.PowerStats.desktop': <{'position': <6>}>, 'gnome-session-properties.desktop': <{'position': <7>}>, 'gnome-system-monitor.desktop': <{'position': <8>}>, 'gucharmap.desktop': <{'position': <9>}>, 'simple-scan.desktop': <{'position': <10>}>, 'org.gnome.Extensions.desktop': <{'position': <11>}>, 'chromium_chromium.desktop': <{'position': <12>}>, 'yelp.desktop': <{'position': <13>}>, 'intellij-idea-community_intellij-idea-community.desktop': <{'position': <14>}>, 'Utilities': <{'position': <15>}>, 'pop-cosmic-applications.desktop': <{'position': <16>}>, 'codium_codium.desktop': <{'position': <17>}>, 'pop-cosmic-workspaces.desktop': <{'position': <18>}>, 'info.desktop': <{'position': <19>}>, 'org.gnome.Totem.desktop': <{'position': <20>}>, 'org.gnome.font-viewer.desktop': <{'position': <21>}>, 'nm-connection-editor.desktop': <{'position': <22>}>, 'org.gnome.FileRoller.desktop': <{'position': <23>}>}, {'org.gnome.DiskUtility.desktop': <{'position': <0>}>, 'org.gnome.Evince.desktop': <{'position': <1>}>, 'org.gnome.eog.desktop': <{'position': <2>}>}]"
gsettings set org.gnome.shell favorite-apps "['pop-cosmic-launcher.desktop', 'org.gnome.Nautilus.desktop', 'firefox.desktop', 'com.tutanota.Tutanota.desktop', 'org.standardnotes.standardnotes.desktop', 'webapp-Notion6139.desktop', 'net.ankiweb.Anki.desktop', 'libreoffice-writer.desktop', 'com.github.xournalpp.xournalpp.desktop', 'codium_codium.desktop', 'intellij-idea-community_intellij-idea-community.desktop', 'android-studio_android-studio.desktop', 'org.gnome.Terminal.desktop']"
