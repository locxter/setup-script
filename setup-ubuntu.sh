...
sudo apt install libfuse2 libserialport0 patchelf git build-essential gdb cmake openjdk-17-jdk maven android-sdk-platform-tools lm-sensors neofetch minicom curl gedit-plugins mat2 bleachbit gnome-boxes tilp2 cura inkscape anki kiwix freecad arduino xournalpp musescore3 -y
if $DATA_DRIVE
then
